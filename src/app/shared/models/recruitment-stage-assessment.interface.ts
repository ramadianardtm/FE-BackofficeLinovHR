...
export interface StageAssessmentH {
    id?: string;
    nik: string;
    name: string;
    email : string; 
...
export interface StageAssessmentI {
    id?: string;
    nik: string;
    ...
    personProjectExperiences?:PersonProjectExperience[];
...
export class ProjectExperiencesSub {
    id?: string;
    company: string;
    location: string;
    dateBegin: Date;
...
export class RecruitmentStageRequest {
    pageInfo = new PageInfo(1, Paginator.rowsPerPage);
}
export class RecruitmentStageRequestSearch {
